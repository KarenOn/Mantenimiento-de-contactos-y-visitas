...
namespace ExamenFinal.Controllers
{
    public class ContactosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdNombre,Nombrecompleto,Cedula,Fechacreacion")] Contactos contactos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdNombre,Nombrecompleto,Cedula,Fechacreacion")] Contactos contactos)
        {
            if (ModelState.IsValid)
            {
